...
object TestData {
  ...
  val testEffectiveDate = Instant.parse("2019-01-02T22:10:13.686Z")
  val testPriceUniqueKey = PricingCalculatorPriceUniqueKey(testPriceName, testEffectiveDate)
  val testPriceUniqueKey2 = PricingCalculatorPriceUniqueKey(testPriceName, Instant.parse("2019-01-03T22:10:13.686Z"))
  ...
  val testPriceRecord = new PricingCalculatorPriceRecord(testPriceName, testEffectiveDate, testPriceItem)
  ...
  val sampleSKUGooglePriceJson: String =
    """
      |{
      |  "skus": [
      |     {
